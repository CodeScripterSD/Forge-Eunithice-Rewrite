...
public class AsphaltInfuserRecipeCategory implements IRecipeCategory<AsphaltInfuserRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(Eunithice.MODID, "infuser");
    ...
    public Component getTitle() {
        return new TranslatableComponent("eunithice.compat.jei.infusing_category");
    }
    @Override
