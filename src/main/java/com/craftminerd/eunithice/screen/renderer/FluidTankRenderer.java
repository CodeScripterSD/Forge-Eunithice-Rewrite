package com.craftminerd.eunithice.screen.renderer;
...
//            long milliBuckets = (amount * 1000) / FluidType.BUCKET_VOLUME;
            ...
            if (tooltipMode == TooltipMode.SHOW_AMOUNT_AND_CAPACITY) {
                MutableComponent amountString = new TranslatableComponent("eunithice.tooltip.liquid.amount.with.capacity", nf.format(amount), nf.format(capacity));
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            } else if (tooltipMode == TooltipMode.SHOW_AMOUNT) {
                MutableComponent amountString = new TranslatableComponent("eunithice.tooltip.liquid.amount", nf.format(amount));
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            }
