...
public class AsphaltInfuserRecipeBuilder implements RecipeBuilder {
    private final Item result;
    private final NonNullList<Ingredient> recipeItems;
    private final int count;
    private final boolean ignoreDurability;
    private final Advancement.Builder advancement = Advancement.Builder.advancement();
    public AsphaltInfuserRecipeBuilder(NonNullList<Ingredient> recipeItems, ItemLike result, int count, boolean ignoreDurability) {
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        pFinishedRecipeConsumer.accept(new AsphaltInfuserRecipeBuilder.Result(pRecipeId, this.result, this.count, this.ignoreDurability, this.recipeItems,
    ...
    public static class Result implements FinishedRecipe {
        ...
        public ResourceLocation getId() {
            return new ResourceLocation(Eunithice.MODID, this.result.getRegistryName().getPath() + "_from_infusing_" + this.recipeItems.get(0).getItems()[0].getItem().getRegistryName().getPath());
        }

        @Override
        public RecipeSerializer<?> getType() {
            return AsphaltInfuserRecipe.Serializer.INSTANCE;
        }
